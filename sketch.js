...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if (gameState.lives === 0 || gameState.score >= objetivoPuntuacion) {
...
function reset(){
  ...
  const kangarooElement = document.getElementById('kangaroo');
kangarooElement.style.animationDuration = '1s';
  // Destruye los arbustos y el grupo de obstáculos
  bushesGroup.destroy(true);
